...
//!
//! Upstream mapping:
//! - `packages/json-random/src/examples.ts`
//!
//! Rust divergence:
//! - Upstream exports `const` templates; Rust exposes constructor functions so
//!   recursive templates and time-dependent literals can be generated lazily.
...
pub fn api_response_detailed() -> Template {
    ...
    Template::obj(vec![
        req("success", Template::lit(json!(true))),
        req("timestamp", Template::lit(json!(now))),
        req(
            "data",
            Template::arr(
                Some(5),
    ...
    Template::obj(vec![
        req(
            ...
            Template::obj(vec![
                ...
                req("timeout", Template::int(Some(1000), Some(30_000))),
...
pub fn user_token() -> Template {
    ...
    Template::obj(vec![
        ...
        req(
            "expiresAt",
            Template::int(Some(now), Some(now + 86_400_000)),
        ),
        req(
            "scope",
            Template::arr(
...
pub fn log_entry() -> Template {
    ...
    Template::obj(vec![
        req(
            "timestamp",
            Template::int(Some(now - 86_400_000), Some(now)),
        ),
        req(
            "level",
            Template::str(Some(Token::pick(vec![
...
pub fn metric_data() -> Template {
    ...
    Template::obj(vec![
        ...
        req("timestamp", Template::int(Some(now - 3_600_000), Some(now))),
        req(
            "tags",
            Template::obj(vec![
                req(
...
pub fn bank_account() -> Template {
    ...
    Template::obj(vec![
        ...
        req(
            "lastActivity",
            Template::int(Some(now - 2_592_000), Some(now)),
        ),
    ])
}
...
pub fn social_post() -> Template {
    ...
    Template::obj(vec![
        ...
        req(
            "timestamp",
            Template::int(Some(now - 604_800_000), Some(now)),
        ),
        opt(
            "media",
            Template::arr(
...
pub fn iot_device() -> Template {
    ...
    Template::obj(vec![
        ...
        req("lastSeen", Template::int(Some(now - 86_400_000), Some(now))),
        req(
            "sensors",
...
pub fn medical_record() -> Template {
    ...
    Template::obj(vec![
        ...
        req(
            "visitDate",
            Template::int(Some(now - 31_536_000), Some(now)),
        ),
        req(
            "provider",
            Template::obj(vec![
        ...
        req(
            ...
            Template::arr(
                ...
                Some(Template::obj(vec![
                    ...
                    req("maxScore", Template::lit(json!(100))),
                    req(
                        "dueDate",
                        Template::int(Some(now - 7_776_000), Some(now + 7_776_000)),
                    ),
...
pub fn empty_structures() -> Template {
    Template::obj(vec![
        ...
        req("emptyString", Template::lit(json!(""))),
        req("nullValue", Template::nil()),
        req("zeroNumber", Template::lit(json!(0))),
        req("falseBool", Template::lit(json!(false))),
    ])
}
    ...
    Template::obj(vec![
        ...
        req(
            ...
            Template::str(Some(Token::list(vec![
                ...
                Token::literal(" "),
                Token::char_range(0x1f600, 0x1f64f, Some(1)),
                Token::literal(" "),
...
pub fn large_numbers() -> Template {
    Template::obj(vec![
        req(
            "maxSafeInteger",
            Template::lit(json!(9_007_199_254_740_991i64)),
        ),
        req(
            "minSafeInteger",
            Template::lit(json!(-9_007_199_254_740_991i64)),
        ),
        req("largeFloat", Template::float(Some(1e10), Some(1e15))),
        req("smallFloat", Template::float(Some(1e-10), Some(1e-5))),
        req(
            "preciseDecimal",
            Template::float(Some(0.000001), Some(0.999999)),
        ),
        req("scientificNotation", Template::lit(json!(1.23e-45))),
    ])
}
