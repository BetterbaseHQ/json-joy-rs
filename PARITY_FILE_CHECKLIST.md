...
- Check a row only when implementation + tests + fixture parity + core differential parity are complete.
...
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/block/Block.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/block/Block.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/block/Fragment.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/block/Fragment.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/block/Inline.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/block/Inline.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/block/LeafBlock.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/block/LeafBlock.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
...
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/block/index.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/block/mod.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/block/types.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/block/types.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
...
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/editor/Cursor.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/editor/Cursor.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/editor/Editor.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/editor/Editor.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/editor/EditorSlices.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/editor/EditorSlices.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
...
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/editor/types.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/editor/types.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/editor/util.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/editor/util.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/events/PeritextEventTarget.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/events/PeritextEventTarget.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
...
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/events/clipboard/DomClipboard.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/events/clipboard/DomClipboard.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/events/clipboard/types.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/events/clipboard/types.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/events/defaults/PeritextEventDefaults.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/events/defaults/PeritextEventDefaults.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/events/defaults/annals.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/events/defaults/annals.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/events/defaults/types.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/events/defaults/types.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/events/defaults/ui/UiHandle.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/events/defaults/ui/UiHandle.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/events/defaults/ui/types.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/events/defaults/ui/types.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/events/index.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/events/mod.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/events/types.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/events/types.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
...
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/overlay/Overlay.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/overlay/Overlay.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/overlay/OverlayPoint.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/overlay/OverlayPoint.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
...
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/overlay/refs.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/overlay/refs.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/overlay/types.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/overlay/types.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/registry/SliceBehavior.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/registry/SliceBehavior.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/registry/SliceRegistry.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/registry/SliceRegistry.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/registry/types.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/registry/types.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
...
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/transfer/PeritextDataTransfer.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/transfer/PeritextDataTransfer.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
...
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/transfer/create.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/transfer/create.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/transfer/export-html.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/transfer/export-html.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/transfer/export-markdown.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/transfer/export-markdown.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/transfer/import-html.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/transfer/import-html.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/transfer/import-markdown.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/transfer/import-markdown.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/transfer/jsx.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/transfer/jsx.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
...
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/util/ChunkSlice.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/util/ChunkSlice.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
...
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/util/commonLength.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/util/commonLength.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/peritext/util/types.ts` -> `crates/json-joy/src/json-crdt-extensions/peritext/util/types.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/prosemirror/FromPm.ts` -> `crates/json-joy/src/json-crdt-extensions/prosemirror/FromPm.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/prosemirror/ProseMirrorApi.ts` -> `crates/json-joy/src/json-crdt-extensions/prosemirror/ProseMirrorApi.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/prosemirror/ProseMirrorNode.ts` -> `crates/json-joy/src/json-crdt-extensions/prosemirror/ProseMirrorNode.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
...
- [x] `packages/json-joy/src/json-crdt-extensions/prosemirror/constants.ts` -> `crates/json-joy/src/json-crdt-extensions/prosemirror/constants.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/prosemirror/index.ts` -> `crates/json-joy/src/json-crdt-extensions/prosemirror/mod.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/prosemirror/types.ts` -> `crates/json-joy/src/json-crdt-extensions/prosemirror/types.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/prosemirror/util.ts` -> `crates/json-joy/src/json-crdt-extensions/prosemirror/util.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/quill-delta/QuillDeltaApi.ts` -> `crates/json-joy/src/json-crdt-extensions/quill-delta/QuillDeltaApi.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/quill-delta/QuillDeltaNode.ts` -> `crates/json-joy/src/json-crdt-extensions/quill-delta/QuillDeltaNode.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
...
- [x] `packages/json-joy/src/json-crdt-extensions/quill-delta/constants.ts` -> `crates/json-joy/src/json-crdt-extensions/quill-delta/constants.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/quill-delta/index.ts` -> `crates/json-joy/src/json-crdt-extensions/quill-delta/mod.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/quill-delta/types.ts` -> `crates/json-joy/src/json-crdt-extensions/quill-delta/types.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/quill-delta/util.ts` -> `crates/json-joy/src/json-crdt-extensions/quill-delta/util.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/slate/FromSlate.ts` -> `crates/json-joy/src/json-crdt-extensions/slate/FromSlate.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/slate/SlateApi.ts` -> `crates/json-joy/src/json-crdt-extensions/slate/SlateApi.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/slate/SlateNode.ts` -> `crates/json-joy/src/json-crdt-extensions/slate/SlateNode.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
...
- [x] `packages/json-joy/src/json-crdt-extensions/slate/constants.ts` -> `crates/json-joy/src/json-crdt-extensions/slate/constants.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/slate/index.ts` -> `crates/json-joy/src/json-crdt-extensions/slate/mod.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
- [x] `packages/json-joy/src/json-crdt-extensions/slate/types.ts` -> `crates/json-joy/src/json-crdt-extensions/slate/types.rs` (SKIPPED: JS editor adapter out of scope for Rust/WASM)
...
- [x] (SKIPPED: JS editor adapter out of scope for Rust/WASM) `packages/json-joy/src/json-patch/slate.ts` -> `crates/json-joy/src/json-patch/slate.rs`
...
- [x] `packages/json-joy/src/json-crdt-extensions/` -> `crates/json-joy/src/json_crdt_extensions/` (COMPLETE — peritext core done; JS editor adapters out of scope for Rust/WASM)

### WASM Adapter Slices — removed from scope

- [x] `W0-W6` JS editor adapter parity work (`slate`, `prosemirror`, `quill-delta`, peritext editor/events) is intentionally out of scope for this repository.
